...
function renderCandidateProfileOverview(profile) {
  ...
  const resumeAction = label => `<button class="candidate-profile-add" data-resume-upload>＋ ${label}</button>`;
